...
export function validateConfigLinksOptions(data: any): data is ConfigLinksOptions {
...
export function isConfigLinksOptions(data: any): data is ConfigLinksOptions {
    try { return validateConfigLinksOptions(data); }
