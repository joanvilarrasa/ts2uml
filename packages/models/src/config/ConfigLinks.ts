...
export function validateConfigLinks(data: unknown): data is ConfigLinks {
...
export function isConfigLinks(data: unknown): data is ConfigLinks {
	try {
		return validateConfigLinks(data);
	} catch (e) {
		return false;
	}
}
