...
export function validateConfigLinksFilter(data: any): data is ConfigLinksFilter {
...
export function isConfigLinksFilter(data: any): data is ConfigLinksFilter {
    try { return validateConfigLinksFilter(data); }
