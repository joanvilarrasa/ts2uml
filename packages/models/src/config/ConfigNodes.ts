...
export function validateConfigNodes(data: any): data is ConfigNodes {
...
export function isConfigNodes(data: any): data is ConfigNodes {
    try { return validateConfigNodes(data); }
