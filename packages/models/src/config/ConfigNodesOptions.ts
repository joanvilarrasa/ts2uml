...
export function validateConfigNodesOptions(data: any): data is ConfigNodesOptions {
...
export function isConfigNodesOptions(data: any): data is ConfigNodesOptions {
    try { return validateConfigNodesOptions(data); }
