...
export function validateLinkType(data: any): data is LinkType {
...
export function isLinkType(data: any): data is LinkType {
    try { return validateLinkType(data); }
...
export function validateLink(data: any): data is Link {
