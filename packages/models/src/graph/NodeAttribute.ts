...
export function validateNodeAttributeType(data: any): data is NodeAttributeType {
...
export function isNodeAttributeType(data: any): data is NodeAttributeType {
    try { return validateNodeAttributeType(data); }
...
export function validateNodeAttributeScope(data: any): data is NodeAttributeScope {
...
export function isNodeAttributeScope(data: any): data is NodeAttributeScope {
    try { return validateNodeAttributeScope(data); }
    catch (e) { return false; }
}
...
export function validateNodeAttribute(data: any): data is NodeAttribute {
...
export function isNodeAttribute(data: any): data is NodeAttribute {
    try { return validateNodeAttribute(data); }
    catch (e) { return false; }
}
