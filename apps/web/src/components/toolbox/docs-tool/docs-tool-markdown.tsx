      ...
      <div className="prose prose-sm dark:prose-invert max-w-none p-4">
        <ReactMarkdown
          ...
          components={{
            ...
            h2: ({ className, ...props }) => <h2 className={cn('mt-5 mb-3 font-bold text-xl', className)} {...props} />,
            h3: ({ className, ...props }) => <h3 className={cn('mt-4 mb-2 font-bold text-lg', className)} {...props} />,
            h4: ({ className, ...props }) => (
              <h4 className={cn('mt-3 mb-1 font-bold text-base', className)} {...props} />
            ),
            p: ({ className, ...props }) => <p className={cn('my-2', className)} {...props} />,
            ul: ({ className, ...props }) => <ul className={cn('my-2 list-disc pl-6', className)} {...props} />,
            ol: ({ className, ...props }) => <ol className={cn('my-2 list-decimal pl-6', className)} {...props} />,
            ...
            blockquote: ({ className, ...props }) => (
              <blockquote className={cn('my-3 border-muted border-l-4 pl-4', className)} {...props} />
            ),
