...
function createConfigLinksFilter(data) {
  return ZConfigLinksFilter.parse({
    filter_type: data?.filter_type ?? []
  });
}

// src/types/config/config-links-options.ts
var ZConfigLinksOptions = z.object({
...
function createConfigLinksOptions(data) {
...
// src/types/config/link-path-algorithm.ts
var ZLinkPathAlgorithm = z.enum(["straight", "bezier", "step"]);

// src/types/config/config-links.ts
var ZConfigLinks = z.object({
  filter: ZConfigLinksFilter,
  options: ZConfigLinksOptions,
  linkPathAlgorithm: ZLinkPathAlgorithm.default("straight")
});
function createConfigLinks(data) {
...
// src/types/config/config-nodes-options.ts
var ZConfigNodesOptions = z.object({
...
function createConfigNodesOptions(data) {
...
// src/types/config/config-nodes.ts
var ZConfigNodes = z.object({
...
function createConfigNodes(data) {
...
function createNodeAttribute(data) {
...
// src/types/graph/node-title.ts
var ZNodeTitle = z.object({
  id: z.string({ invalid_type_error: "id must be a string" }),
  nodeType: ZNodeType,
  style: ZNodeStyle.optional(),
  text: z.string({ invalid_type_error: "text must be a string" })
...
// src/types/messages/msg-update-layout-algorithm.ts
var ZMsgUpdateLayoutAlgorithm = z.object({
  layoutAlgorithm: ZLayoutAlgorithm,
  type: ZMsgType.extract(["update-layout-algorithm"])
});
function createMsgUpdateLayoutAlgorithm(data) {
...
// src/types/messages/msg-update-link-path-algorithm.ts
var ZMsgUpdateLinkPathAlgorithm = z.object({
  linkPathAlgorithm: ZLinkPathAlgorithm,
  type: ZMsgType.extract(["update-link-path-algorithm"])
});
function createMsgUpdateLinkPathAlgorithm(data) {
...
function validate(data, zSchema) {
  try {
    zSchema.parse(data);
    return true;
  } catch (e) {
